...
import com.cryptopay.prototype.adapter.TabsFragmentAdapter;
...
import com.cryptopay.prototype.service.MainService;
...
//        viewPager.setCurrentItem(Constants.TAB_ONE);
    ...
    public void switchSend() {
        Intent intent = new Intent(BackActivity.this, SendActivity.class);
        startActivity(intent);
    }

    public void switchPurse() {
        Intent intent = new Intent(BackActivity.this, PurseActivity.class);
        startActivity(intent);
    }

    public void switchContent(Advert advert) {
        Intent intent = new Intent(BackActivity.this, ShopActivity.class);
